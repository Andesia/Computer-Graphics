...
void DrawAlienBody(bool isPlayer1,bool isPlayer2)
{
	if (isPlayer1)
...
void DrawAlienFace(bool isPlayer1, bool isPlayer2)
{
...
void DrawAlienEyes(bool isPlayer1, bool isPlayer2)
{
	// if(isPlayer1)
	glColor3f(0, 1, 1);
	// else
...
void DrawAlien(bool isPlayer1,bool isPlayer2)
{
	DrawAlienBody(isPlayer1,isPlayer2);
	DrawAlienCollar();
	DrawAlienFace(isPlayer1,isPlayer2);
	DrawAlienBeak();
	DrawAlienEyes(isPlayer1,isPlayer2);
}
...
void gameScreenDisplay()
{
	...
	glTranslatef(6, 150, 0);
		...
		if (laser2) {
			...
			checkLaserContact(xTwo, yTwo, laser2Dir, -xOne, yOne, false,true);
		}
		glPopMatrix();
	}
	else {
